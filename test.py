...
Sound.play("/home/robot/Programs/astar-car/sounds/XP Startup.wav").wait()
...
while True:
	...
	Sound.play("/home/robot/Programs/astar-car/sounds/Uh Oh.wav").wait()
	...
	Sound.play("/home/robot/Programs/astar-car/sounds/Wee.wav").wait()